...
def cliptriangleagainstplane(point_on_plane, plane_normal, triangle_to_clip, debug=True):
	...
	if len(inside_points) == 2 and len(outside_points) == 1:
		...
		out_triangle1 = Triangle(triangle_to_clip.point_matrix)
		...
		if debug:
			print("Shittt")
			print("Outside point: " + str(outside_points[0]))
		out_triangle1.point_matrix[2] = intersection_between_plane_and_line(point_on_plane, plane_normal, inside_points[0], bullshit)
		if debug:
		...
		out_triangle2.point_matrix[2] = intersection_between_plane_and_line(point_on_plane, plane_normal, inside_points[1], bullshit, debug=True)
		if debug:
