...
if __name__=="__main__":
	screenwidth = 500
	screenheight = 500
	#triangle = Triangle(np.array([[-20.0,0.0,15.0,1.0], [0.0,0.0,15.0,1.0], [-20.0,-20.0,15.0,1.0]]))
	triangles = load_smd("/home/cyberhacker/Asioita/Jannat/decompile/Soria_Pose_Ref3.smd", np.array([0.0,0.0,100.0,0.0]))
