...
if __name__=="__main__":
	...
	triangles = load_object_file("./axis.obj", np.array([0,0,10.0,0]))
	...
	for count in range(how_many_cycles):
		...
		for triangle in triangles:
			...
			for i in range(number_of_clipped_triangles):
				...
				if out_triangles[i].point_matrix[0][2] != out_triangles[i].point_matrix[1][2] and out_triangles[i].point_matrix[1][2] != out_triangles[i].point_matrix[2][2]:
					print("BULLBULLBULL")
